...
```scala
package psbp.specification.composition
...
```scala
package psbp.specification.construction
...
```scala
package psbp.specification.condition
...
import psbp.specification.composition.Composition

import psbp.specification.construction.Construction

import psbp.specification.condition.Condition

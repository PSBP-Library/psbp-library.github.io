...
// import psbp.external.specification.aggregatable.{ TraversableAtLeft, TraversableAtRight }

// private[psbp] given consTraversableAtLeft[>-->[- _, + _]: Program]: TraversableAtLeft[Cons, >-->] = productTraversableAtLeft[Constant, Identity, >-->]

// private[psbp] given consTraversableAtRight[>-->[- _, + _]: Program]: TraversableAtRight[Cons, >-->] = productTraversableAtRight[Constant, Identity, >-->]

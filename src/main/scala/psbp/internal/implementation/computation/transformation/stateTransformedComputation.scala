...
private[psbp] given stateTransformedTransformationWithBinding[
  S
  , C[+ _]: Computation
]: 
  Transformation[C, StateTransformed[S, C]] 
  with Binding[[Y] =>> StateTransformed[S, C][Y]] with
...
private[psbp] given stateTransformedComputation[S, C[+ _]: Computation]: Computation[StateTransformed[S, C]] = 
  stateTransformedTransformationWithBinding[S, C]
